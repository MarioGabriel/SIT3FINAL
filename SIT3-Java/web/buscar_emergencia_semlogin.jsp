<%-- 
    Document   : buscar_emergencia_semlogin
    Created on : 06/12/2016, 15:24:20
    Author     : samue
--%>
    ...
    <div id="map"></div>
        ...
        <%
                ...
                while (i < lista_hospitais.size()){
                    %>
                    <h3><a href='buscar_emergencia_semlogin.jsp?dest=<%=maps.getCoordinates(lista_hospitais.getItem(i).getItem(2))%>&hospid=<%=lista_hospitais.getItem(i).getItem(0)%>'><%=lista_hospitais.getItem(i).getItem(1)%> </a>
