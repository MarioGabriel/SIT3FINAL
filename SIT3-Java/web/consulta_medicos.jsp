    ...
    <% 
       ...
       while (i < lista_medico.size()) {
           ...
           <h3><%= lista_medico.getItem(i).getItem(1)%> - <%= lista_medico.getItem(i).getItem(3)%> - 
               <a href="consulta_medicos.jsp?action=remove&medid=<%=lista_medico.getItem(i).getItem(0)%>">[Excluir]</a> |
               <a href="editar_medico.jsp?medid=<%=lista_medico.getItem(i).getItem(0)%> "> [Alterar]</a> |
               <a href="relacao_medico_hospital.jsp?medid=<%=lista_medico.getItem(i).getItem(0)%> "> [Incluir hospital em que trabalha]</a> 
           </h3>
           <%
           i++;
       }
